...
python3 $GUI_SCRIPT_DIR/test_executor/run_robot_suites.py --suite_dir=$GUI_SCRIPT_DIR/aut/msc/suites/master_suite/suite1/user_suite.txt --gui_script_dir=$GUI_SCRIPT_DIR --gui_var_file=$GUI_SCRIPT_DIR/test_executor/AutVars.py --path_to_python=
